...
Правила именования файлов для cli команд
{Название команды}.command.ts
Пример: version.command.ts
Если команда состоит из нескольких слов - разделяем через дефис: new-command.command.ts
