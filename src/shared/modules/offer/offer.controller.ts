...
export class OfferController extends BaseController {
  constructor(
    ...
    this.addRoute({ path: '/favorite/:offerId/:status', method: HttpMethod.Post, handler: this.updateFavoriteStatus, middlewares: [new ValidateObjectIdMiddleware('offerId')] });
